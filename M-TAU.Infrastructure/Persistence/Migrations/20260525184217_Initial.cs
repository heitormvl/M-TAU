        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Measures = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    WeightCapacity = table.Column<double>(type: "REAL", nullable: false),
                    UsageTime = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    ProductId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TechnicalSpecs_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TechnicalSpecs_ProductId",
